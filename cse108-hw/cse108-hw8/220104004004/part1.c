...
void print_matrix(matrix_struct initial_matrix)
{
    for (int i = 0; i < 3; i++)
    {
        for (int j = 0; j < 3; j++)
...
void determinant_of_matrix(matrix_struct *initial_matrix)
{
...
int inverse_matrix(matrix_struct* initial_matrix, matrix_struct *inverted_matrix)
{
...
int main()
{
    matrix_struct initial_matrix;
    matrix_struct inverted_matrix;
